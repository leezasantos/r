...
ggplot(df, aes(x=sex, y=LOS)) + geom_boxplot() + ylim(1, 15) + ggtitle("length of stay per sex")
...
# pie chart for sex
ggplot(df, aes(x=factor(1), fill=sex)) + geom_bar(width = 1)+ coord_polar("y") + scale_fill_grey() + ggtitle("sex ")
